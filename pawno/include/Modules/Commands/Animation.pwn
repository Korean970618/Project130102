...
public pCommandTextHandler_Animation(playerid, cmdtext[])
{
	...
	else if (strcmp(cmd, "/수갑애니", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "PED", "pass_Smoke_in_car", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/엎드리기", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
	 	ApplyAnimation(playerid, "PED", "Drown", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/금지", true) == 0)
	{
		...
		switch(strval(cmd))
		{
			case 1: ApplyAnimation(playerid, "PED", "endchat_01", 4.1, 0, 1, 1, 1, 1, 1);
			case 2: ApplyAnimation(playerid, "PED", "endchat_02", 4.1, 0, 1, 1, 1, 1, 1);
			case 3: ApplyAnimation(playerid, "POLICE", "CopTraf_Stop", 4.1, 0, 1, 1, 1, 1, 1);
	...
	else if (strcmp(cmd, "/억울", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "OTB", "betslp_tnk", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/조직인사", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "FAT", "IDLE_tired", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/말", true) == 0)
	{
		...
		switch(strval(cmd))
		{
			case 1: ApplyAnimation(playerid, "PED", "IDLE_CHAT", 4.1, 0, 1, 1, 1, 1, 1);
			case 2: ApplyAnimation(playerid, "GHANDS", "gsign5", 4.1, 0, 1, 1, 1, 1, 1);
	...
	else if (strcmp(cmd, "/승리", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "ON_LOOKERS", "Pointup_in", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/엿", true) == 0)
	{
		...
		switch(strval(cmd))
		{
			case 1: ApplyAnimation(playerid, "PED", "fucku", 4.1, 0, 1, 1, 1, 1, 1);
	...
	else if (strcmp(cmd, "/백스텝", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "PED", "FightShB", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/총맞고걷기", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "SWEET", "LaFin_Sweet", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/환호", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "STRIP", "PUN_HOLLER", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/걷어차기", true) == 0)
	{
		...
		switch(strval(cmd))
		{
			case 1: ApplyAnimation(playerid, "POLICE", "Door_Kick", 4.1, 0, 1, 1, 1, 1);
	...
	else if (strcmp(cmd, "/총들기", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "SILENCED", "Silence_fire", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/총조준", true) == 0)
	{
		...
		switch(strval(cmd))
		{
			case 1: ApplyAnimation(playerid, "PED", "gang_gunstand", 4.1, 0, 1, 1, 1, 1, 1);
			case 2: ApplyAnimation(playerid, "SWORD", "sword_IDLE", 4.1, 0, 1, 1, 1, 1, 1);
			case 3: ApplyAnimation(playerid, "POLICE", "COP_getoutcar_LHS", 4.1, 0, 1, 1, 1, 1, 1);
			case 4: ApplyAnimation(playerid, "SHOP", "SHP_Gun_Aim", 4.1, 0, 1, 1, 1, 1, 1);
			case 5: ApplyAnimation(playerid, "QUAD", "QUAD_driveby_FT", 4.1, 0, 1, 1, 1, 1, 1);
	...
	else if (strcmp(cmd, "/자위", true) == 0)
	{
		...
		switch(strval(cmd))
		{
			case 1: ApplyAnimation(playerid, "PAULNMAC", "wank_loop", 4.1, 0, 1, 1, 1, 1, 1);
	...
	else if (strcmp(cmd, "/앉기", true) == 0 || strcmp(cmd, "/seat", true) == 0)
	{
		...
		switch(strval(cmd))
		{
			case 1: ApplyAnimation(playerid, "PED", "SEAT_down", 4.1, 0, 1, 1, 1, 1, 1);
			case 2: ApplyAnimation(playerid, "INT_HOUSE", "LOU_Loop", 4.1, 0, 1, 1, 1, 1, 1);
			case 3: ApplyAnimation(playerid, "SUNBATHE", "ParkSit_M_IdleA", 4.1, 0, 1, 1, 1, 1, 1);
			case 4: ApplyAnimation(playerid, "SUNBATHE", "ParkSit_M_in", 4.1, 0, 1, 1, 1, 1, 1);
			case 5: ApplyAnimation(playerid, "SUNBATHE", "ParkSit_W_idleA", 4.1, 0, 1, 1, 1, 1, 1);
			case 6: ApplyAnimation(playerid, "SWAT", "gnstwall_injurd", 4.1, 0, 1, 1, 1, 1, 1);
	...
	else if (strcmp(cmd, "/기대기", true) == 0)
	{
		...
		switch(strval(cmd))
		{
			case 1: ApplyAnimation(playerid, "MISC", "Plyrlean_loop", 4.1, 0, 1, 1, 1, 1, 1);
			case 2: ApplyAnimation(playerid, "GANGS", "leanIN", 4.1, 0, 1, 1, 1, 1, 1);
	...
	else if (strcmp(cmd, "/구르기", true) == 0)
	{
		...
		switch(strval(cmd))
		{
			case 1: ApplyAnimation(playerid, "MD_CHASE", "MD_BIKE_Lnd_Roll", 4.1, 0, 1, 1, 1, 1, 1);
			case 2: ApplyAnimation(playerid, "MD_CHASE", "MD_BIKE_Lnd_Roll_F", 4.1, 0, 1, 1, 1, 1, 1);
	...
	else if (strcmp(cmd, "/바지지퍼", true) == 0)
	{
		...
		switch(strval(cmd))
		{
			...
			case 2: ApplyAnimation(playerid, "PAULNMAC", "Piss_out", 4.1, 0, 1, 1, 1, 1, 1);
	...
	else if (strcmp(cmd, "/엿보기", true) == 0)
	{
		...
		switch(strval(cmd))
		{
			case 1: ApplyAnimation(playerid, "SWAT", "swt_wllpk_L", 4.1, 0, 1, 1, 1, 1, 1);
			case 2: ApplyAnimation(playerid, "SWAT", "swt_wllpk_R", 4.1, 0, 1, 1, 1, 1, 1);
	...
	else if (strcmp(cmd, "/인사", true) == 0)
	{
		...
		switch(strval(cmd))
		{
			...
			case 2: ApplyAnimation(playerid, "GHANDS", "gsign5LH", 4.1, 0, 1, 1, 1, 1, 1);
			case 3: ApplyAnimation(playerid, "BD_FIRE", "BD_GF_Wave", 4.1, 0, 1, 1, 1, 1, 1);
			case 4: ApplyAnimation(playerid, "BD_FIRE", "BD_Panic_01", 4.1, 0, 1, 1, 1, 1, 1);
	...
	else if (strcmp(cmd, "/컴퓨터", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "INT_OFFICE", "OFF_Sit_Type_Loop", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/쓰기", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "OTB", "betslp_in", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	{
		ApplyAnimation(playerid, "ON_LOOKERS", "point_in", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/놀라기", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "PED", "handscower", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/엎어지기", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "FOOD", "FF_Die_Bkw", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/대걸레질", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "CHAINSAW", "CSAW_3", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/묶임", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "BIKE_DBZ", "Pass_Driveby_RHS", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/응원", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "ON_LOOKERS", "shout_02", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/쓰러지기", true) == 0)
	{
		...
		switch(strval(cmd))
		{
			case 1: ApplyAnimation(playerid, "PED", "FLOOR_hit", 4.1, 0, 1, 1, 1, 1, 1);
			case 2: ApplyAnimation(playerid, "PED", "KO_skid_back", 4.1, 0, 1, 1, 1, 1, 1);
	...
	else if (strcmp(cmd, "/히치하이킹", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "PED", "IDLE_taxi", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/악수", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "PED", "Jetpack_Idle", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/주유하기", true) == 0)
	{
		...
		switch(strval(cmd))
		{
			case 1: ApplyAnimation(playerid, "BAR", "Barserve_glass", 4.1, 0, 1, 1, 1, 1, 1);
			case 2: ApplyAnimation(playerid, "BAR", "Barserve_bottle", 4.1, 0, 1, 1, 1, 1, 1);
	...
	else if (strcmp(cmd, "/마시기", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "BAR", "dnk_stndF_loop", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/차에서손내밀기", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "CAR", "Tap_hand", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (strcmp(cmd, "/팔짱", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "OTB", "wtchrace_loop", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	else if (strcmp(cmd, "/복종", true) == 0)
	{
		if (IsPlayerInAnyVehicle(playerid))
			return SendClientMessage(playerid, COLOR_WHITE, "차에 탄 채로 애니메이션을 사용할 수 없습니다.");
		ApplyAnimation(playerid, "COP_AMBIENT", "Copbrowse_in", 4.1, 0, 1, 1, 1, 1, 1);
		return 1;
	}
	...
	else if (!strcmp(cmd, "/animscratching", true))
	{
		...
		switch(strval(cmd))
		{
			...
			case 7: ApplyAnimation(playerid, "SCRATCHING", "SendClientMessageid_l", 4.1, 0, 1, 1, 1, 1);
			case 8: ApplyAnimation(playerid, "SCRATCHING", "SendClientMessageid_r", 4.1, 0, 1, 1, 1, 1);
